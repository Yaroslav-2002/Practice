...
Button(text='Sin', bd=5, font=('Arial', 13),  command=lambda : operation_sin('Sin')).grid(row=1, column=4, stick='wens', padx=5, pady=5)
Button(text='Cos', bd=5, font=('Arial', 13),  command=lambda : operation_cos('Cos')).grid(row=2, column=4, stick='wens', padx=5, pady=5)
